...
void	T2UAPI	t2u_init_v2(const char* svraddr,unsigned short svrport,const char* svrkey,const char* logpath);
...
设置重连间隔(秒) , 范围5-300
*/
int	T2UAPI	t2u_set_reconnect_interval(int second);
