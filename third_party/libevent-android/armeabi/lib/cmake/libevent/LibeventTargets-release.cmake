...
set_target_properties(event PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent.so"
  IMPORTED_SONAME_RELEASE "libevent.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS event )
list(APPEND _IMPORT_CHECK_FILES_FOR_event "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent.so" )
...
set_target_properties(event_core PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "m"
  IMPORTED_LOCATION_RELEASE "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent_core.so"
  IMPORTED_SONAME_RELEASE "libevent_core.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS event_core )
list(APPEND _IMPORT_CHECK_FILES_FOR_event_core "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent_core.so" )
...
set_target_properties(event_extra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "m"
  IMPORTED_LOCATION_RELEASE "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent_extra.so"
  IMPORTED_SONAME_RELEASE "libevent_extra.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS event_extra )
list(APPEND _IMPORT_CHECK_FILES_FOR_event_extra "/home/dengpan/allCompileLibeventLibssl20171009/tmp/libevent-2.1.8/armeabi/lib/libevent_extra.so" )
